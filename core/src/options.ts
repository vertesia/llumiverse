...
export const textOptionsFallback: ModelOptionsInfo = {
    ...
    options: [
        { name: "max_tokens", type: OptionType.numeric, min: 1, max: 4096, default: 128, description: "The maximum number of tokens to generate" },
        { name: "temperature", type: OptionType.numeric, min: 0, max: 1, default: 1, description: "The temperature of the generated image" },
        ...
        { name: "presence_penalty", type: OptionType.numeric, min: 0, max: 1, default: 0, description: "The presence penalty of the generated image" },
        { name: "frequency_penalty", type: OptionType.numeric, min: 0, max: 1, default: 0, description: "The frequency penalty of the generated image" },
